...
export function getCheckpoints(destination) {
  return [
    ...
    { day: 5, status: "In Transit — Over Ocean", location: "International Airspace", detail: "Package is en route to destination continent", iconName: "Plane" },
    ...
    { day: 7, status: "Approaching Destination", location: `En route to ${destination.country}`, detail: "Package nearing destination country airspace", iconName: "Plane" },
